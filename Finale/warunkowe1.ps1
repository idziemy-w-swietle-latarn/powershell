...
$imie_M2 = Read-Host 'imie mianownik'
$imie_D2 = Read-Host 'imie w dope³niaczu'
$imie_C2 = Read-Host 'imie w celowniku'
$nazwisko2 = Read-Host 'nazwisko'
$pan2 = Read-Host 'Pan czy Pani'
$adres_doreczenia2 = Read-Host 'ulica i numery do doreczenia'
$kod_miasto_doreczenia2 = Read-Host 'kod i miasto doreczenia'
$data_ogloszenia2 = Read-Host 'data og³osenia: XX miesi¹ca XXXX'
